...
{
    CameraVectorSupplier INSTANCE = AntiCheatAddition.getInstance().getConfig().getBoolean("Esp.calculate_third_person_modes", false) ? new ThirdPersonCameraSupplier() : new SingleCameraSupplier();
