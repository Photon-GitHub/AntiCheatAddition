...
public final class ModuleManager {
    ...
    static {
        final var moduleList = new ArrayList<>(Arrays.asList(
                ...
                ViolationModule.parentOf("PacketAnalysis", PacketAnalysisHorseJump.INSTANCE, PacketAnalysisAimStep.INSTANCE, PacketAnalysisAnimation.INSTANCE, PacketAnalysisEqualRotation.INSTANCE, PacketAnalysisExtremeYaw.INSTANCE, PacketAnalysisIllegalPitch.INSTANCE, PacketAnalysisMalformed.INSTANCE, PacketAnalysisPerfectRotation.INSTANCE, PacketAnalysisPacketFlood.INSTANCE, PacketAnalysisDigging.INSTANCE, PacketAnalysisDroppingPayload.INSTANCE, PacketAnalysisHeldSlot.INSTANCE, PacketAnalysisSequence.INSTANCE, PacketAnalysisStab.INSTANCE, PacketAnalysisUseItem.INSTANCE),
